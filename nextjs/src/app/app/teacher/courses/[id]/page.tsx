  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <button
            onClick={() => router.push('/app/teacher/courses')}
                ...
                <div className="flex items-start space-x-6 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                      <span
                        className={`px-3 py-1 rounded-full text-sm font-medium ${getCategoryText(course.category as any) === '听力训练' ? 'bg-blue-100 text-blue-800' : getCategoryText(course.category as any) === '阅读理解' ? 'bg-green-100 text-green-800' : getCategoryText(course.category as any) === '写作训练' ? 'bg-purple-100 text-purple-800' : getCategoryText(course.category as any) === '翻译练习' ? 'bg-orange-100 text-orange-800' : 'bg-gray-100 text-gray-800'}`}
                      >
