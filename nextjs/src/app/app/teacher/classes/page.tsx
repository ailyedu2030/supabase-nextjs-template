...
import { Search, Filter, Users, Eye, Plus, Trash2, BookOpen, Calendar } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">我的班级</h1>
            <p className="mt-2 text-gray-600">管理您的班级</p>
          </div>
          <Link
