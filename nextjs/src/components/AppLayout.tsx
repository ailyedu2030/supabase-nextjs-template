...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: 'Training', href: '/app/training', icon: BookOpen },
    { name: 'Progress', href: '/app/progress', icon: TrendingUp },
    { name: 'Error Book', href: '/app/error-book', icon: AlertCircle },
    { name: 'Courses', href: '/app/courses', icon: GraduationCap },
    { name: 'AI Grading', href: '/app/AIgrading', icon: Key },
    { name: 'Notifications', href: '/app/notifications', icon: Files },
